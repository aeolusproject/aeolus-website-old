module NewsHelper
  def all_news
    [
      %Q(Oz version 0.3.0 is released.  Tarballs and packages are available from <a href="oz-download.html">here</a>.),
      %Q(Oz version 0.2.0 is released.  Tarballs and packages are available from <a href="oz-download.html">here</a>.),
