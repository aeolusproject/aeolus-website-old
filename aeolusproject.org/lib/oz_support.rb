module OzSupportHelper
  def ozguests
    [
     ...
     { :name => "OpenSUSE 11.{0,1,2,3,4}", :install => true, :customize => false, :icicle => true },
     { :name => "Ubuntu 6.10, 7.04, 7.10, 8.04, 8.10, <br /> 9.04, 9.10, 10.04, 10.10", :install => true, :customize => false, :icicle => false },
